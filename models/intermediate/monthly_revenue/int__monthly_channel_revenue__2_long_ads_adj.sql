...
longs__claim__ad_rev_adj__monthly as (
    ...
    from {{ ref('int__longs__claim__ad_rev__daily_channel_rev_adj') }}
    group by
        report_date_key,
        asset_channel_id
...
int__monthly_channel_revenue__2_long_ads_adj as (
    ...
    left join longs__claim__ad_rev_adj__monthly as long_ads_adj on
        long_ads.report_date_key = long_ads_adj.report_date_key
        and
        long_ads.asset_channel_id = long_ads_adj.asset_channel_id
