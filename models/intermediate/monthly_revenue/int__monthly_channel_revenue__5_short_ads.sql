with channel_revenue__non_music_sub as (
...
shorts__video__ad_rev as (
    ...
    from
        {{ ref('int__shorts__video__ad_rev__monthly_channel_rev') }}
    group by
        report_date_key,
        channel_id
...
int__monthly_channel_revenue__5_short_ads as (
    ...
    left join shorts__video__ad_rev as shorts_ad
        on
            channel_revenue.report_date_key = shorts_ad.report_date_key
            and
            channel_revenue.asset_channel_id = shorts_ad.channel_id
