with int__channel_revenue__music_sub as (
...
longs__asset__sub_rev__monthly as (
    ...
    from
        {{ ref('int__longs__asset__sub_rev__daily_channel_rev') }}
    group by
        report_date_key,
        asset_channel_id
...
int__monthly_channel_revenue__4_long_non_music_sub as (
    ...
    left join longs__asset__sub_rev__monthly as non_music_sub on
        channel_revenue.report_date_key = non_music_sub.report_date_key
        and
        channel_revenue.asset_channel_id = non_music_sub.asset_channel_id
