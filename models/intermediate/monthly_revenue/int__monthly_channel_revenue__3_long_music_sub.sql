...
longs__music_asset__sub_rev__monthly as (
    ...
    from
        {{ ref('int__longs__music_asset__sub_rev__daily_channel_rev') }}
    group by
        report_date_key,
        asset_channel_id
...
int__monthly_channel_revenue__3_long_music_sub as (
    ...
    left join
        longs__music_asset__sub_rev__monthly as music_sub on
        revenue_by_channel.report_date_key = music_sub.report_date_key
        and
        revenue_by_channel.asset_channel_id = music_sub.asset_channel_id
