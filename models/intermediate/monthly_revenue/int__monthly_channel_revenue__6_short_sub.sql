with channel_revenue__short_ads as (
...
shorts__video__sub_rev as (
    ...
    from
        {{ ref('int__shorts__video__sub_rev__daily_channel_rev') }}
    group by
        report_date_key,
        channel_id
...
int__monthly_channel_revenue__6_short_sub as (
    ...
    left join shorts__video__sub_rev as shorts_sub
        on
            channel_revenue.report_date_key = shorts_sub.report_date_key
            and
            channel_revenue.asset_channel_id = shorts_sub.channel_id
